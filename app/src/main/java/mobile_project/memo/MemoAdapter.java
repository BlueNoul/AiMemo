...
public class MemoAdapter extends RecyclerView.Adapter<MemoAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            textView = itemView.findViewById(R.id.memointext) ;
        }
    }
    ...
    public MemoAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.memos_item, parent, false) ;
    ...
    // onBindViewHolder() - 포지션에 해당하는 데이터를 뷰홀더의 아이템뷰에 표시.
    @Override
